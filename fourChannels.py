...
def record(filename):
	...
	write(filename+'_'+action_id+'_ch0.wav', 40000, scaled0)
	write(filename+'_'+action_id+'_ch1.wav', 40000, scaled1)
	write(filename+'_'+action_id+'_ch2.wav', 40000, scaled2)
	write(filename+'_'+action_id+'_ch3.wav', 40000, scaled3)

	raw_input("Press Enter to continue...")



print randomBasicAction()
print randomBasicAction()
print randomBasicAction()
print randomBasicAction()
print randomBasicAction()
