...
void setup(){
 ...
 ADC->ADC_CHER=0b11110000; // (Channel Enable Register) enable channel bit corresponding analog input port A0 A1
 ...
 //ADC->ADC_CGR = 0xF000; //
 ADC->ADC_CGR = ADC_CGR_GAIN0(11) | ADC_CGR_GAIN1(11) | ADC_CGR_GAIN2(11) | ADC_CGR_GAIN3(11);
 ADC->ADC_COR = ADC_COR_OFF0 | ADC_COR_OFF1 | ADC_COR_OFF2 | ADC_COR_OFF3 ;
